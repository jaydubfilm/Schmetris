...
namespace StarSalvager
{
    ...
    public class ResourceCollectedMission : Mission
    {
        ...
        public ResourceCollectedMission(BIT_TYPE resourceType, string missionName, List<Dictionary<string, object>> missionUnlockData, int amountNeeded) : base(missionName, amountNeeded, missionUnlockData)
        {
