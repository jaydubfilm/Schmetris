...
namespace StarSalvager.Prototype
{
    ...
    public class EnemyBulletV2 : MonoBehaviour
    {
        ...
        public void MosquitoBulletBehaviour(Vector3 target, Sprite sprite, Vector3 dir, float bulletLifetime,
            float bulletSpeed, int damageDealt)
        {
        ...
        public void MamaBulletBehaviour(Transform player, Sprite sprite, float bulletSpeed, float bulletLifetime,
            int damageDealt)
        {
