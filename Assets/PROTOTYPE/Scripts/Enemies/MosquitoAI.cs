...
//Mosquito type enemy behaviour
    public class MosquitoAI : Enemy
    {
        ...
        protected override void OnLevelComplete()
        {
            ...
            GetComponent<Rigidbody2D>().velocity = new Vector3(0,
                -GameController.Instance.blockSpeed * GameController.Instance.adjustedSpeed, 0);
        }
        ...
        void Fire()
        {
            ...
            thisBullet.MosquitoBulletBehaviour(player.position, bulletSprite, dir, bulletLifetime, bulletSpeed,
                bulletDamage);
        }
